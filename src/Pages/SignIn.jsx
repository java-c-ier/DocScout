      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div style={{ display: "grid" }}>
            <div style={{ gridArea: "1/1", transition: "opacity 0.35s cubic-bezier(0.4,0,0.2,1), transform 0.35s cubic-bezier(0.4,0,0.2,1)", opacity: tab === "signup" ? 1 : 0, transform: tab === "signup" ? "translateX(0)" : "translateX(18px)", pointerEvents: tab === "signup" ? "auto" : "none" }}>{formBody(false)}</div>
            <div style={{ gridArea: "1/1", transition: "opacity 0.35s cubic-bezier(0.4,0,0.2,1), transform 0.35s cubic-bezier(0.4,0,0.2,1)", opacity: tab === "login" ? 1 : 0, transform: tab === "login" ? "translateX(0)" : "translateX(-18px)", pointerEvents: tab === "login" ? "auto" : "none" }}>{formBody(true)}</div>
          </div>
